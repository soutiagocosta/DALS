			...
			<table class="table table-condensed">
				...
				<tbody>
					<?php foreach($resultado as $row){ ?>
				  	<tr>
					  	<td><?php echo $row['id_leilao'] ?></td>
					  	<td><?php echo $row['username']?></td>
					  	<td><?php echo $row['password']?></td>
					  	<td><?php echo $row['salt']?></td>
					  	<td><a href="tratar.php?id=<?php echo($row['id']); ?>"><button type="button" class="glyphicon glyphicon-remove" aria-label="Left Align" name="delete"></button></a>
